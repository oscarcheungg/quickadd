...
const searchFieldHTML = (q) => `<div class="field"><span class="muted">⌕</span><input id="q" type="search" placeholder="Search Spotify, or your own playlists" value="${esc(q)}" autocomplete="off" autocorrect="off" spellcheck="false" enterkeyhint="search">${q ? `<button class="clear" data-action="clearq">✕</button>` : ""}</div>`;
